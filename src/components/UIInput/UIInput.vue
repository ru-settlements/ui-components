<template>
  <form action="#login" class="form">
    <div class="form__fields">
      <input type="email" id="email" class="form__control-input form__control-input-email" placeholder=" " required>

      <label for="email" class="form__control-label form__control-label-email">
        Логин/ Эл. почта
      </label>
      ...
      <button type="submit" class="form__button form__submit">
        Войти
      </button>
